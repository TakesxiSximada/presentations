...
- [共著] Pythonエンジニア ファーストブック (技術評論社)
- [監修] PythonとJavaScriptではじめるデータビジュアライゼーション (オライリージャパン)
- [監修] Pythonではじめるデータラングリング (オライリージャパン)
- [監修] PythonによるWebスクレイピング (オライリージャパン)
- [共著] Pythonエンジニア養成読本 (技術評論社)
